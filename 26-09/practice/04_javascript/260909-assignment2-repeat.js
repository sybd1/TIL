...
console.log(`판매가능: ${product.isAvailable}`);
console.log(`상품명 타입: ${typeof product.productName}`);
console.log(`가격 타입: ${typeof product.price}`);
console.log(`판매 가능 타입: ${typeof product.isAvailable}`);
...
const result = (inputPrice * 1) + (inputDeliveryFee * 1);
console.log(`총 결제 금액: ${result}`);
...
const key = products['price'];
console.log(`가격: ${key}`);
console.log(`남은 재고: ${products.stock - 2}`);
products.isAvailables = products.stock > 0;
console.log(`판매 가능: ${products.isAvailables}`);
delete products.category;
console.log(`삭제 후 카테고리: ${products.category}`);
